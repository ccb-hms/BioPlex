...
1. `log2ratio` is really just the mean of the five HEK samples, divided by the mean of the five HCT samples (and then taking log2 of it):
...
2. `adj.pvalue` is really just a BH-adjusted t-test derived p-value:

```{r}
tt <- genefilter::rowttests(assay(bp.prot), as.factor(bp.prot$cell.line))
